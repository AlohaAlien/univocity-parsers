...
/**
 *
 * A convenience {@link Processor} implementation for storing all
 * {@link MasterDetailRecord} generated form the parsed input into a list.
...
public abstract class AbstractMasterDetailListProcessor<T extends Context> extends AbstractMasterDetailProcessor<T> {
	...
	/**
	 * Creates a MasterDetailListProcessor assuming master records are positioned
	 * above its detail records in the input.
	 *
	 * @param detailProcessor the {@link ObjectRowListProcessor} that processes
	 *                        detail rows.
	 */
	...
	/**
	 * Stores the generated {@link MasterDetailRecord} with the set of associated
	 * parsed records into a list.
	 *
	 * @param record  {@link MasterDetailRecord} generated with a set of associated
	 *                records extracted by the parser
	...
	/**
	 * Returns the list of generated MasterDetailRecords at the end of the parsing
	 * process.
	 * 
	 * @return the list of generated MasterDetailRecords at the end of the parsing
	 *         process.
	 */
