...
/**
 * A convenience {@link Processor} implementation for storing all java objects
 ...
 * parser.parse(reader); // will invoke the {@link AbstractBeanListProcessor#beanProcessed(Object, C)}
 * 						// method for each generated object.
 *
...
public abstract class AbstractBeanListProcessor<T, C extends Context> extends AbstractBeanProcessor<T, C> {
	 ...
	 * Creates a processor that stores java beans of a given type into a list
	 *
	 * @param beanType          the class with its attributes mapped to fields of
	 *                          records parsed by an {@link AbstractParser} or
	 ...
	 *
	 * @param bean    java bean generated with the information extracted by the
