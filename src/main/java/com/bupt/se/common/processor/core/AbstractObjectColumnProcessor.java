 ...
 * implementation of {@link AbstractParser} into columns of objects.
 * <p>
 ...
 *
 * <p>
 * At the end of the process, the user can access the lists with values parsed
 * for all columns using the methods {@link #getColumnValuesAsList()},
 * {@link #getColumnValuesAsMapOfIndexes()} and
 * {@link #getColumnValuesAsMapOfNames()}.
 * </p>
 *
 * <p>
 * <b>Note:</b> Storing the values of all columns may be memory intensive. For
 * large inputs, use a {@link AbstractBatchedObjectColumnProcessor} instead
 * </p>
 *
 * @see AbstractParser
 * @see Processor
...
public abstract class AbstractObjectColumnProcessor<T extends Context> extends AbstractObjectProcessor<T>
	...
	/**
	 * Constructs a column processor pre-allocating room for the expected number of
