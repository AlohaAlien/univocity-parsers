...
/**
 *
 * A {@link RowWriterProcessor} implementation for converting annotated java
 * objects into object arrays suitable for writing in any implementation of
 * {@link AbstractWriter}.
 * <p>
 ...
 *
 * <p>
 * For any given java bean instance, this processor will read and convert
 * annotated fields into an object array.
 *
 *
...
public class BeanWriterProcessor<T> extends BeanConversionProcessor<T> implements RowWriterProcessor<T> {
	 ...
	 *
	 * @param input          an instance of the type defined in this class
	 *                       constructor.
