 ...
 * Namely: {@link AbstractColumnProcessor},
 * {@link AbstractObjectColumnProcessor}, {@link AbstractBatchedColumnProcessor}
...
interface ColumnReader<T> {
	...
	/**
	 * Returns the column headers. This can be either the headers defined in
	 * {@link CommonSettings#getHeaders()} or the headers parsed in
