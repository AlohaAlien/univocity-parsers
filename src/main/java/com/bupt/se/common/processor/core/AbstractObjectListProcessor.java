...
/**
 * A convenience {@link Processor} implementation for storing all rows parsed
 * and converted to Object arrays into a list.
 ...
 * parser.parse(reader); // will invoke the {@link AbstractObjectListProcessor#rowProcessed(Object[],
 * 						// T)} method for each parsed record.
 *
...
public abstract class AbstractObjectListProcessor<T extends Context> extends AbstractObjectProcessor<T> {
	 ...
	 *                         {@link List} returned by {@link #getRows()}
	 */
	...
	/**
	 * Stores the row extracted by the parser and them converted to an Object array
	 * into a list.
	 *
	 * @param row     the data extracted by the parser for an individual record and
	 *                converted to an Object array.
