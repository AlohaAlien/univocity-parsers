...
/**
 * An implementation of {@link CharAppender} that does nothing. Used by
 * {@link ParserOutput} to transparently discard any unwanted input while
 * parsing.
 *
...
public class NoopCharAppender implements CharAppender {
	...
	/**
	 * This is a singleton class and cannot be instantiated. Use
	 * {@link NoopCharAppender#getInstance()}.
	 */
