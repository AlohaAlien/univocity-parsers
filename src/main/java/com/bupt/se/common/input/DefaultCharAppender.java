...
public class DefaultCharAppender implements CharAppender {
	...
	/**
	 * Creates a DefaultCharAppender with a maximum limit of characters to append
	 * and the default value to return when no characters have been accumulated.
	 ...
	 * {@link DefaultCharAppender#appendIgnoringWhitespace(char)},
	 * {@link DefaultCharAppender#appendIgnoringPadding(char, char)} or
	 * {@link DefaultCharAppender#appendIgnoringWhitespaceAndPadding(char, char)}
	 * <p>
	 ...
	 * appended characters where ignored as whitespace or padding), then the return
	 * value will be {@link DefaultCharAppender#emptyValue} attribute defined in the
	 * constructor of this class.
	 *
	 * @return a String containing the accumulated characters without the trailing
	 *         white spaces. Or the {@link DefaultCharAppender#emptyValue} defined
	 ...
	 * If the accumulated value is empty (i.e. no characters were appended, or all
	 * appended characters where ignored as whitespace or padding), then the return
	 * value will be character sequence of the
	 * {@link DefaultCharAppender#emptyValue} attribute defined in the constructor
	 * of this class.
	 *
	 * @return a character array containing the accumulated characters without the
	 *         trailing white spaces. Or the characters of the
	 *         {@link DefaultCharAppender#emptyValue} defined in the constructor of
	 *         this class.
	 */
	@Override
	...
	/**
	 * Appends the contents of another DefaultCharAppender, discarding any of its
