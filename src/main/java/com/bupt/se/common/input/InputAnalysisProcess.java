 ...
 * {@link AbstractCharInputReader#reloadBuffer()} loads a batch of characters
 * from the input,
 * the {@code InputAnalysisProcess} will be executed and then discarded.
 *
 * <p>
 * Parsers can implement their custom analysis processes to identify patterns
 * and attempt to automatically derive configuration options to process the
 * input
 * by calling
 * {@link AbstractCharInputReader#addInputAnalysisProcess(InputAnalysisProcess)}
 * at any time.
 * </p>
 *
