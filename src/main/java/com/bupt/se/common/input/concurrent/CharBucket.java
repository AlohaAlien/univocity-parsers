...
class CharBucket {
	...
	/**
	 * The number of characters this bucket contain. It is modified every time
	 * {@link CharBucket#fill(Reader)} is called.
	 */
	int length = -1;
	 ...
	 * <p>
	 * The {@link CharBucket#length} attribute will be updated with the number of
	 ...
	 * @throws IOException if any error occurs while extracting characters from the
	 *                     reader
	 */
