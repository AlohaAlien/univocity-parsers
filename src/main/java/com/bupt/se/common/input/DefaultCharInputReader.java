...
/**
 * A default CharInputReader which only loads batches of characters when
 * requested by the {@link AbstractCharInputReader} through the
 * {@link DefaultCharInputReader#reloadBuffer} method.
 *
...
public class DefaultCharInputReader extends AbstractCharInputReader {
	 ...
	 *                                found in the input.
	 * @param bufferSize              the buffer size used to store characters read
	 *                                from the input.
	 ...
	 * {@link DefaultCharInputReader#buffer}, and updates the
	 * {@link DefaultCharInputReader#length} to the number of characters read.
	 */
	@Override
