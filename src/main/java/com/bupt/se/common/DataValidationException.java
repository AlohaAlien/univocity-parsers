...
/**
 * A {@code DataValidationException} is an error thrown during the processing of
 * a record successfully parsed,
 * but whose data failed to pass a validation defined by annotation
 * {@link com.bupt.se.annotations.Validate}
 *
...
public class DataValidationException extends DataProcessingException {
	...
	/**
	 * Creates a new validation exception with an error message and the row that
	...
	/**
	 * Creates a new validation exception with an error message, the row that could
	 * not be validated, and the error cause.
	 *
	 * @param message the error message
	 * @param row     the row that could not be processed.
	 * @param cause   the cause of the error
	...
	/**
	 * Creates a new validation exception with an error message and the column that
	 * could not be validated.
	 *
	 * @param message     the error message
