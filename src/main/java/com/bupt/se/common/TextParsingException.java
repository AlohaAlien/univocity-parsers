 ...
 * while parsing from a given input.
 * <p>
 * It generally provides location information about where in the input a parsing
 * error occurred.
 *
...
public class TextParsingException extends AbstractException {
	...
	/**
	 * Returns the location of the last character read from before the error
	 * occurred.
	 *
	 * @return the location of the last character read from before the error
	 *         occurred.
	 */
