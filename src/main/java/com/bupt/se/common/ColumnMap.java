...
/**
 * Class responsible for calculating and storing the position of fields parsed
 * from the input.
 *
...
public class ColumnMap {
	...
	private void validateHeader(Object header) {
		if (header == null) {
			...
			throw new IllegalArgumentException("Header name cannot be null. Use one of the available column names: "
					+ Arrays.asList(context.headers()));
		}
	}
