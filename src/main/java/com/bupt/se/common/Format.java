...
/**
 * This is the parent class for all configuration classes that define a text
 * format.
 *
 * <p>
 * By default, all parsers and writers have to handle, at least, the following
 * format definitions:
 *
 * <ul>
 * <li><b>lineSeparator:</b> the 1-2 character sequence that indicates the end
 * of a line. Newline sequences are different across operating systems.
 * Typically:
 * <ul>
 ...
 * </li>
 * <li><b>normalizedNewline:</b> a single character used to represent the end of
 * a line uniformly in any parsed content. It has the following implications:
 * <ul>
 * <li>When <i>reading</i> a text-based input, the sequence of characters
 * defined in {@link Format#lineSeparator} will be replaced by this
 * character.</li>
 * <li>When <i>writing</i> to a text-based output, this character will be
 * replaced by the sequence of characters defined in
 * {@link Format#lineSeparator}.</li>
 * </ul>
 * <p>
 * <i>{@link Format#normalizedNewline} defaults to '\n'.</i>
 * </li>
 * <li><b>comment:</b>a character that, if found in the beginning of a line of
 * text, represents comment in any text-based input supported by
 * univocity-parsers.
 * <p>
 * <i>{@link Format#comment} defaults to '#'.</i></li>
 * </ul>
 *
...
public abstract class Format implements Cloneable {
	...
	/**
	 * Returns the current line separator character sequence, which can contain 1 to
	 * 2 characters. Defaults to the system's line separator sequence (usually
	 ...
	 * Defaults to the system's line separator sequence (usually "\r\n" in Windows,
	 * "\r" in MacOS, and "\n" in Linux/Unix).
	 * 
	 * @return the sequence of 1 to 2 characters that identifies the end of a line
	 */
	...
	/**
	 * Defines the line separator sequence that should be used for parsing and
	 * writing.
	 * 
	 * @param lineSeparator a sequence of 1 to 2 characters that identifies the end
	 *                      of a line
	 */
	 ...
	 * {@link Format#lineSeparator} when reading/writing. Defaults to '\n'.
	 * 
	 ...
	 * {@link Format#lineSeparator} when reading/writing
	 * 
	 * @param normalizedNewline a single character used to represent a line
	 *                          separator.
	 */
	...
	/**
	 * Compares the given character against the {@link Format#normalizedNewline}
	 * character.
	 * 
	 * @param ch the character to be verified
	 * @return true if the given character is the normalized newline character,
	 *         false otherwise
	 */
	...
	/**
	 * Defines the character that represents a line comment when found in the
	 * beginning of a line of text. Defaults to '#'
	 * <p>
