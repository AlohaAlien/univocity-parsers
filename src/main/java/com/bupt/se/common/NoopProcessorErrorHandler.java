...
/**
 * An (singleton) implementation of {@link ProcessorErrorHandler} that simply
 * rethrows any {@link DataProcessingException}
 * that comes into its
 * {@link #handleError(DataProcessingException, Object[], Context)}} method
 *
...
public final class NoopProcessorErrorHandler<T extends Context> implements ProcessorErrorHandler<T> {
	 ...
	 *                 Will be rethrown to abort the parsing process.
