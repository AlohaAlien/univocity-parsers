 ...
 * {@link com.bupt.se.common.processor.core.Processor} and
 * {@link com.bupt.se.common.record.Record}.
 *
...
public interface Context {
	 ...
	 * selected fields, as specified by {@link #extractedFieldIndexes()}
	 *
	 ...
	 * automatically unless {@link CommonParserSettings#isAutoClosingEnabled()}
	...
	/**
	 * Returns the length limit of parsed contents appearing in exception messages
	 * when an error occurs
	 *
	 * <p>
	 * If {@code 0}, then no exceptions will include the content being manipulated
	 * in their attributes,
	 ...
	 * .
	 *
	 * @return the maximum length of the data content to display in exception
	 *         messages
	 */
	...
	/**
	 * Returns the metadata information associated with records produced by the
