 ...
 * <p>
 * This selector stores undesired fields, represented by values of an
 * enumeration,
 * and will return the indexes of those fields that are not part of the
 * selection.
 *
...
public class ExcludeFieldEnumSelector extends FieldSet<Enum> implements FieldSelector {
	...
	/**
	 * Returns the indexes of any that are part of a sequence of headers but not
