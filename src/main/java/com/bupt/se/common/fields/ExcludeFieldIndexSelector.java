 ...
 *
 * <p>
 * This selector stores undesired fields and will return the indexes of those
 * fields that are not part of the selection.
 *
 * @see FieldSelector
 * @see FieldSet
 *
...
public class ExcludeFieldIndexSelector extends FieldSet<Integer> implements FieldSelector {
	 ...
	 * 
	 * @param columns the sequence of headers that might have some elements selected
