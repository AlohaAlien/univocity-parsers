 ...
 *
 * This removes the requirement of having classes annotated with {@link Parsed}
 * or
 * {@link Nested}.
 *
...
public interface ColumnMapper extends Cloneable {
	 ...
	 *                      Use the dot character to access attributes of nested
	 *                      objects,
	 *                      e.g. {@code contact.mobile} will target the attribute
	 *                      "mobile"
	 *                      from a Contact attribute inside a Customer class.
	 * @param columnName    the name of the column that:
	 *                      (a) when parsing, will be read from to populate the
	 *                      given attribute of an object;
	 *                      (b) when writing, will receive the value of the given
	 ...
	 *
	 * @param mappings a map of attribute names associated with a corresponding
	 *                 column name, where:
	 *
	 *                 <ul>
	 *                 <li>Each <b>key</b> is the name of the attribute. Use the dot
	 *                 character to access attributes of nested objects,
	 *                 e.g. {@code contact.mobile} will target the attribute
	 *                 "mobile"
	 *                 from a Contact attribute inside a Customer class.
	 *                 </li>
	 *                 <li>Each <b>value</b> is the name of the column that:
	 *                 (a) when parsing, will be read from to populate the given
	 *                 attribute of an object;
	 *                 (b) when writing, will receive the value of the given
	 *                 attribute of an object;
	 *                 </li>
	 ...
	 *                 from a Contact attribute inside a Customer class.
	 *                 </li>
	 *                 <li>Each <b>value</b> is an enumeration representing the
	 *                 column that:
	 *                 (a) when parsing, will be read from to populate the given
	 *                 attribute of an object;
	 *                 (b) when writing, will receive the value of the given
	 ...
	 *                 from a Contact attribute inside a Customer class.
	 *                 </li>
	 *                 <li>Each <b>value</b> is an integer representing the position
	 *                 of the column that:
	 *                 (a) when parsing, will be read from to populate the given
	 *                 attribute of an object;
	 *                 (b) when writing, will receive the value of the given
	...
	/**
	 * Maps a setter method to a column name. Use when
	 * {@link #methodToColumnName(String, String)}
	 ...
	 *                      Use the dot character to access methods of nested
	 *                      objects,
	 *                      e.g. {@code contact.mobile} will target the setter
	 *                      method "mobile(String)"
	 *                      from a Contact attribute inside a Customer class.
	 * @param parameterType the type of the parameter used in the given setter name.
	 * @param columnName    the name of the column that when parsing, will be read
	 *                      from to invoke given setter method of an object
	 *
	 */
	void methodToColumnName(String setterName, Class<?> parameterType, String columnName);

	/**
	 * Maps a setter method to a column. Use when
	 * {@link #methodToColumnName(String, String)}
	 * is not enough to uniquely identify the method you need (e.g. when there are
	 * overloaded methods with different parameter types)
	 *
	 ...
	 *                      from a Contact attribute inside a Customer class.
	 * @param parameterType the type of the parameter used in the given setter name.
	 * @param column        an enumeration representing the column that when
	 *                      parsing, will be read from to invoke given setter method
	 *                      of an object
	 */
	void methodToColumn(String setterName, Class<?> parameterType, Enum<?> column);

	/**
	 * Maps a setter method to a column position. Use when
	 * {@link #methodToColumnName(String, String)}
	 * is not enough to uniquely identify the method you need (e.g. when there are
	 * overloaded methods with different parameter types)
	 *
	 ...
	 *                      from a Contact attribute inside a Customer class.
	 * @param parameterType the type of the parameter used in the given setter name.
	 * @param columnIndex   the position of the column that when parsing, will be
	 *                      read from to invoke given setter method of an object
	 */
	 ...
	 *
	 * When parsing, only "setter" methods will be used i.e. the given method
	 * accepts one parameter.
	 * If the method is overridden, use
	 * {@link #methodToColumnName(String, Class, String)}
	 ...
	 *                   e.g. {@code contact.mobile} will target the method
	 *                   "mobile(String)" when parsing, or "String mobile()" when
	 *                   writing,
	 *                   from a Contact attribute inside a Customer class.
	 * @param columnName the name of the column that:
	 *                   (a) when parsing, will be read from to invoke given setter
	 *                   method of an object;
	 *                   (b) when writing, will receive the value returned by the
	 *                   given getter method of an object;
	 *
	 */
	 ...
	 *
	 * @param mappings a map of methods names associated with a corresponding column
	 *                 name, where:
	 *
	 *                 <ul>
	 *                 <li>Each <b>key</b> is the name of a method. Use the dot
	 *                 character to access attributes of nested objects,
	 *                 e.g. {@code contact.mobile} will target the method
	 *                 "mobile(String)" when parsing, or "String mobile()" when
	 *                 writing,
	 ...
	 *
	 * @param mappings a map of methods names associated with a corresponding
	 *                 column, where:
	 *
	 *                 <ul>
	 *                 <li>Each <b>key</b> is the name of a method. Use the dot
	...
	/**
	 * Creates a deep copy of this object with all its mappings. Changes to the
	 * clone won't affect the original instance.
	 * 
	 ...
	 * 
	 * @param methodOrAttributeName the name of the method or attribute to be
	 *                              removed.
	 */
