 ...
 * {@link ColumnMapper}
 * 
 * @param <K> the type of key (attribute/method names or specific method
 *            definition with parameter and return types)
 */
abstract class AbstractColumnMapping<K> implements Cloneable {
	 ...
	 *
	 * @param prefix a dot separated sequence of names that represents the nesting
	 *               of complex attributes inside a class (e.g
	 *               customer.contact.phone).
	 * @param parent the parent mapping of columns, relevant only when nested
	 *               objects' attributes or methods are being mapped.
	 */
	 ...
	 * 
	 * @param key        attribute/method name or specific method definition with
	 ...
	 * @param key    attribute/method name or specific method definition with
	 *               parameter and return type
	 * @param column enumeration representing the column associated with the given
	 *               key
	 */
	 ...
	 * @param key         attribute/method name or specific method definition with
	 *                    parameter and return type
	 * @param columnIndex number representing the position of the column associated
	 *                    with the given key
	 */
	 ...
	 *
	 * @param prefix the current object nesting level, denoted by a dot-separated
	 *               string of nested attribute names.
	 * @param key    the key to transform.
	 * @return the transformed key or {@code null} if the key can't be used with the
	 *         given prefix
	 */
	 ...
	 * @param key          the attribute name or method specification that matches
	...
	/**
	 * Returns all prefixes used by the keys in this mapping. These represent names
	 * of
	 * nested objects that will be navigated through to access their
	 * attributes/methods.
	 * 
	 ...
	 * being targeted.
	 *
	 * @param prefix the current prefix - a dot separated string with nested
	 *               attribute names
	 * @param key    the attribute name or method definition. If its own prefix
	 *               starts with the given prefix, the next element after the dot
	 ...
	 *
	 * @param nameWithPrefix name of the attribute or method, prefixed with nested
	 *                       object names that identify the path to the target class
	 *                       member.
	...
	/**
	 * Removes any mappings containing keys that have a given attribute or method
	 * name.
	 *
	 * @param nameWithPrefix name of the attribute or method, prefixed with nested
	 *                       object names that identify the path to the target class
