 ...
 * <p>
 * Also used by
 * {@code com.univocity.parsers.common.processor.ConversionProcessor} to select
 * fields that have to be converted.
 *
 ...
 * @see CommonSettings
 *
 * @param <T> the type of the reference information used to uniquely identify a
...
public class FieldSet<T> implements Cloneable {
	...
	/**
	 * Creates a field set that wraps a collection of other field sets. For internal
	 * use only.
	 * 
	...
	/**
	 * Validates and sets multiple field references. Any existing reference will be
	 * discarded.
	 * 
