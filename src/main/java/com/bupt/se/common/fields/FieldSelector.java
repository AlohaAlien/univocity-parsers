...
/**
 *
 * Interface used to identify classes capable of selecting fields and returning
 * their positions in a given sequence.
 *
...
public interface FieldSelector extends Cloneable {
	...
	/**
	 * Returns the indexes of any selected fields that are part of a sequence of
	 * headers.
	 * 
	 * @param headers the sequence of headers that might have some elements selected
	 *                by this FieldSelector
	...
	/**
	 * Clones this field selector. Changes to the selection on the clone won't be
	 * reflected on the original
	 * 
