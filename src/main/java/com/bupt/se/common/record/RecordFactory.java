...
/**
 * A factory class that provides implementations of {@link Record} based on the
 * current state
 * of an {@link AbstractParser}(via its {@link ParsingContext}), and raw input
 * records.
 */
public class RecordFactory extends AbstractRecordFactory<Record, RecordMetaDataImpl> {
	 ...
	 *
	 * @return a {@link Record} that provides many utility methods for consuming the
	 *         data collected for a record parsed from the input.
	 */
	@Override
