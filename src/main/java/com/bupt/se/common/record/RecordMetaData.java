...
public interface RecordMetaData {
	 ...
	 * {@code setTypeOfColumns(type, columns)}
	 *
	...
	/**
	 * Associates a type with one or more column. This allows the parsed data to be
	 * converted automatically
	 * to the given type when reading data from a {@link Record}, e.g.
	 * {@link Record#toFieldObjectMap(String...)} will
	 * convert the selected field values to their respective types, and then set the
	 * result as the values in the map.
	 *
	...
	/**
	 * Associates a default value with one or more columns, in case the values
	 * contained are {@code null}
	 *
	 * @param defaultValue the value to be used for the given column when the parsed
	 *                     result is {@code null}
	 ...
	 * contained are {@code null}
	 *
	 * @param defaultValue  the value to be used for the given column when the
	 *                      parsed result is {@code null}
	 * @param columnIndexes the column indexes to be associated with a default
	 *                      value.
	 * @param <T>           type of the default value.
	 */
	 ...
	 * {@code setDefaultValueOf(Column, Object)})
	 *
	...
	/**
	 * Associates a sequence of {@link Conversion}s to fields of a given set of
	 * fields
	 *
	 * @param enumType    the type of the enumeration whose values represent headers
	 *                    in the input {@code Record}s
	 * @param conversions the sequence of conversions to apply
	 * @param <T>         the enumeration type
	 *
	 * @return (modifiable) set of fields to be selected and against which the given
	 *         conversion sequence will be applied.
	 */
	@SuppressWarnings("rawtypes")
	 ...
	 * @param conversions the sequence of conversions to apply
	 *
	 * @return (modifiable) set of fields names to be selected and against which the
	 *         given conversion sequence will be applied.
	 */
	@SuppressWarnings("rawtypes")
	 ...
	 * @param conversions the sequence of conversions to apply
	 *
	 * @return (modifiable) set of column indexes to be selected and against which
	 *         the given conversion sequence will be applied.
	 */
	@SuppressWarnings("rawtypes")
	...
	/**
	 * Returns the sequence of headers that have been selected. If no selection has
	 * been made, all available headers
	 * will be returned, producing the same output as a call to method
	 * {@link #headers()}.
	 *
	 * @return the sequence of selected headers, or all headers if no selection has
	 *         been made.
	 */
	String[] selectedHeaders();

	/**
	 * Queries whether a given header name exists in the {@link Record}s parsed from
	 * the input
	 *
	 * @param headerName name of the header
	 *
	 * @return {@code true} if the given header name exists in the input records,
