...
package com.bupt.se.common.record;
...
/**
 * A record parsed from the input, with convenience methods for easier data
 * manipulation.
 * Records are obtained from {@link com.bupt.se.common.AbstractParser} methods
 * such as
 * <ul>
...
public interface Record {
	...
	/**
	 * Returns the {@link RecordMetaData} associated with all records parsed from
	 * the input.
	 * The metadata allows associating types, conversions and default values to any
	 * column, which
	 * will be used when performing operations that can convert plain input strings
	 * into object instances.
	 * Methods such as {@link #toFieldMap(String...)},
	 * {@link #fillFieldMap(Map, String...)} and any other
	 * method that returns Objects will use the metadata information to perform data
	 * conversions.
	 *
	 * @return the metadata object that provides information and basic data
	 *         conversion controls
	 ...
	 *
	 * @return a {@code String} array with all values parsed from the input for this
	 *         record.
	 */
	String[] getValues();

	/**
	 * Returns a selection of plain values obtained from a record parsed from the
	 * input.
	 *
	 * @param fieldNames sequence of field names whose values will be returned.
	 *
	 * @return a {@code String} array with the selected values parsed from the input
	 *         for this record.
	 */
	 ...
	 * @param expectedType the expected type of the value. A conversion will be
	 *                     executed against the value
	...
	/**
	 * Returns the value contained in the given column, after applying a sequence of
	 * conversion over it.
	 *
	 * @param headerName   the name of the column whose value will be returned
	 * @param expectedType the expected type of the value. A conversion will be
	 ...
	 *                     to produce a result with the expected type.
	 * @param <T>          the expected value type
	 * @param conversions  the sequence of {@link Conversion}s to apply over the
	 *                     column value.
	 *
	 * @return the value this record holds at the given column
	 */
	...
	/**
	 * Returns the value contained in the given column, or a default value if the
	 * column contains {@code null}
	 *
	 * @param headerName   the name of the column whose value will be returned
	 * @param defaultValue The default value to use if the column contains
	 *                     {@code null}. Its type will be used to derive
	 *                     the expected type of the value. A conversion will be
	 *                     executed against the value
	 *                     to produce a result with the expected type.
	 * @param <T>          the expected value type
	 *
	 * @return the value this record holds at the given column, or the default value
	 *         in case the columns is {@code null}
	 */
	 ...
	 *
	 * @return the value this record holds at the given column, or the default value
	 *         in case the column is {@code null}
	 */
	<T> T getValue(int columnIndex, T defaultValue);

	/**
	 * Returns the value contained in a given column, after applying a sequence of
	 * conversions over it.
	 *
	 * @param headerName   the name of the column whose value will be returned
	 * @param defaultValue The default value to use if the column contains
	 ...
	 *         {@link RecordMetaData#defaultValueOf(String)}
	 */
	...
	/**
	 * Returns the {@code String} value in the given column, truncating it to a
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code Byte} and
	 * returns the result.
	 * The {@link ByteConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName    the name of the column
	 * @param format        the numeric mask to apply over the parsed content
	 * @param formatOptions a sequence of key-value pairs with options to configure
	 *                      the underlying formatter.
	 *                      Each element must be specified as
	 *                      {@code property_name=property_value},
	 *                      e.g. options={"decimalSeparator=,",
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code Short} and
	 * returns the result.
	 * The {@link ShortConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName    the name of the column
	 * @param format        the numeric mask to apply over the parsed content
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code Integer}
	 * and returns the result.
	 * The {@link IntegerConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName    the name of the column
	 * @param format        the numeric mask to apply over the parsed content
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code Long} and
	 * returns the result.
	 * The {@link LongConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName    the name of the column
	 * @param format        the numeric mask to apply over the parsed content
	 ...
	 * Converts the {@code String} value in the given column to a {@code Long} and
	 * returns the result.
	 * The {@link FloatConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName    the name of the column
	 * @param format        the numeric mask to apply over the parsed content
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code Float} and
	 * returns the result.
	 * The {@link FloatConversion} conversion will be used perform the
	 * transformation.
	 *
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code Double} and
	 * returns the result.
	 * The {@link DoubleConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName    the name of the column
	 * @param format        the numeric mask to apply over the parsed content
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code Character}
	 * and returns the result.
	 * The {@link CharacterConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName the column name
	 *
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code Boolean}
	 * and returns the result.
	 * The {@link BooleanConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName the column name
	 *
	 ...
	 *
	 * @param headerName  the column name
	 * @param trueString  a {@code String} that represents the {@code Boolean} value
	 *                    {@code true}
	 * @param falseString a {@code String} that represents the {@code Boolean} value
	 *                    {@code false}
	 *
	 * @return the {@code Boolean} stored in the given column if its original
	 *         {@code String} value matches
	 *         either the trueString or falseString, otherwise {@code null} or the
	 *         default specified in {@link RecordMetaData#defaultValueOf(String)}
	 */
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code BigInteger}
	 * and returns the result.
	 * The {@link BigIntegerConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName    the column name
	 * @param format        the numeric mask to apply over the parsed content
	 ...
	 *                      "maximumFractionDigits=3"}
	 *
	 * @return the {@code BigInteger} stored in the given column, {@code null} or
	 *         the
	 *         default value specified in
	 *         {@link RecordMetaData#defaultValueOf(String)}
	 */
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code BigDecimal}
	 * and returns the result.
	 * The {@link BigDecimalConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName    the column name
	 * @param format        the numeric mask to apply over the parsed content
	 ...
	 *                      "maximumFractionDigits=3"}
	 *
	 * @return the {@code BigDecimal} stored in the given column, {@code null} or
	 *         the
	 *         default value specified in
	 *         {@link RecordMetaData#defaultValueOf(String)}
	 */
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code Date} and
	 * returns the result.
	 * The {@link DateConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName    the column name
	 * @param format        the numeric mask to apply over the parsed content
	...
	/**
	 * Converts the {@code String} value in the given column to a {@code Calendar}
	 * and returns the result.
	 * The {@link CalendarConversion} conversion will be used perform the
	 * transformation.
	 *
	 * @param headerName    the column name
	 * @param format        the date mask to apply over the parsed content
	 ...
	 * {@link RecordMetaData#convertFields(Conversion[])} will be used perform the
	 * transformation.
	 *
	 * @param headerName the column name
	 *
	 ...
	 *
	 * @param selectedFields the header names to use as keys of the map. If no
	 *                       selection then all headers will be used.
	 *
	 * @return a map containing the selected (or all) header names as the keys, and
	 ...
	 * Converts the record into a map of {@code String} values.
	 *
	 * @param selectedIndexes the column indexes to use as keys of the map. If no
	 *                        selection then all indexes will be used.
	 *
	 * @return a map containing the selected (or all) column indexes as the keys,
	 ...
	 * @param selectedColumns the columns to use as keys of the map. If no selection
	 *                        then all values of the enumeration type will be used.
	 * @param <T>             the enumeration type
	 *
	 * @return a map containing the selected (or all) columns as the keys, and their
	 *         respective values.
	 */
	 ...
	 *
	 * @return the input map, containing the selected header names as the keys, and
	 *         their respective values.
	 */
	 ...
	 *
	 * @return the input map, containing the selected column indexes as the keys,
	 *         and their respective values.
	 */
	...
	/**
	 * Converts the record into a map of {@code Object} values. Conversions must be
	 * registered using
	 * {@link RecordMetaData#convertFields(Conversion[])} or
	 * {@link RecordMetaData#convertIndexes(Conversion[])} (Conversion[])}.
	 * Columns without a known conversion will have their values put into the map as
	 * plain {@code String}s.
	 *
	 * @param selectedFields the column names to use as keys of the map
	 *
	 * @return a map containing the selected column names as the keys, and their
	 *         respective values.
	 */
	 ...
	 * @param selectedIndexes the column indexes to use as keys of the map
	 *
	 * @return a map containing the selected column indexes as the keys, and their
	 *         respective values.
	 */
	 ...
	 * @param <T>             the enumeration type
	 *
	 * @return a map containing the selected columns as the keys, and their
	 *         respective values.
	 */
	<T extends Enum<T>> Map<T, Object> toEnumObjectMap(Class<T> enumType, T... selectedColumns);

	/**
	 * Fills a map with the converted {@code Object} values of this record.
	 * Conversions must be registered using
	 * {@link RecordMetaData#convertFields(Conversion[])} or
	 * {@link RecordMetaData#convertIndexes(Conversion[])} (Conversion[])}.
	 * Columns without a known conversion will have their values put into the map as
	 * plain {@code String}s.
	 ...
	 * @param selectedFields the column names to use as keys of the map
	 *
	 * @return the input map, containing the selected columns as the keys, and their
	 *         respective values.
	 */
