 ...
 *
 * Used to eliminate compile-time dependencies with package {@code java.beans.*}
 * which is not
...
public final class PropertyWrapper {
	...
	/**
	 * Returns the method that should be used to write a value to a property of a
	 * Java bean.
	 * Might be {@code null}.
	 *
	 * @return The method that should be used to write the property value, if
	 *         available.
	 **/
	...
	/**
	 * Returns the method that should be used to read the value of a property of a
	 * Java bean.
	 * Might be {@code null}.
	 *
	 * @return The method that should be used to read the property value, if
	 *         available.
	 */
