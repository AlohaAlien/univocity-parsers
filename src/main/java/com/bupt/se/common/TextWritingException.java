...
/**
 * Exception type used provide information about any issue that might happen
 * while writing to a given output.
 *
 * <p>
 * It generally provides location and data information in case of a writing
 * failure.
 *
...
public class TextWritingException extends AbstractException {
	...
	/**
	 * Creates a new exception with information about an error that occurred when
	 * writing data to some output.
	 *
	 * @param message          message with details about the error
	 * @param recordCount      the number of records written until the error
	 *                         occurred
	 * @param row              the input row that was being written when the error
	 *                         occurred
	 * @param recordCharacters the characters already written to the output record.
	 * @param cause            the cause of the error
	 */
	private TextWritingException(String message, long recordCount, Object[] row, String recordCharacters,
			Throwable cause) {
		super(message, cause);
	 ...
	 *
	 * @param message message with details about the error
	 * @param line    index of the line being written to the output when the error
	 *                occurred
	 ...
	 *
	 * @param message          message with details about the error
	 * @param line             index of the line being written to the output when
	 *                         the error occurred
	 * @param recordCharacters the characters already written to the output record.
	 */
