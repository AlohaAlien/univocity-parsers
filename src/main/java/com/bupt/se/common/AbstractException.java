...
/**
 * Parent class of the Exception classes thrown by univocity-parsers. This class
 * provides utility methods to print out the internal state of the parser/writer
...
abstract class AbstractException extends RuntimeException {
	...
	/**
	 * Returns a detailed message describing the error, and the internal state of
	 * the parser/writer.
	 *
	...
	/**
	 * Allows subclasses to alter the exception message that should be displayed to
	 * end users.
	...
	/**
	 * Subclasses must implement this method to return as much information as
	 * possible about the internal state of the parser/writer.
	 * Use {@link #printIfNotEmpty(String, String, Object)} to create a
	 * comma-separated list of relevant properties and their (non null) values.
	 *
	 * The result of this method is used by the {@link #getMessage()} method to
	 * print out these details after the error message.
	 *
	...
	/**
	 * Returns a generic description of the error. The result of this method is used
	 * by {@link #getMessage()} to print out a general description of the error
	 * before a detailed message of the root cause.
	 *
