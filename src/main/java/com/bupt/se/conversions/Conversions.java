 ...
 ******************************************************************************/
package com.bupt.se.conversions;
 ...
 * {@code com.univocity.parsers.conversions.Conversion}, as well as useful
 * methods for obtaining new instances of these.
 *
...
public class Conversions {
	 ...
	 *
	 * @param length the maximum length a value can contain. Characters after this
	 *               limit will
	 *               be discarded.
	 *
	 ...
	 *
	 * @param replaceRegex the regular expression used to match contents of a given
	 *                     input String
	 * @param replacement  the replacement content to replace any contents matched
	 *                     by the given regular expression
	 *
	 * @return the new instance of {@link RegexConversion} created with the given
	 *         parameters.
	 */
	 ...
	 *
	 * @param nullRepresentations the sequence of Strings that represent a null
	 *                            value.
	 *
	 * @return the new instance of {@link NullStringConversion} created with the
	 *         given parameters.
	 */
	 ...
	 *
	 * @param locale      the {@link Locale} that determines how the date mask
	 *                    should be formatted.
	 * @param dateFormats list of acceptable date patterns. The first pattern in
	 *                    this sequence will be used to convert a Date into a String
	 *                    in {@link DateConversion#revert(Date)}.
	 *
	 * @return the new instance of {@link DateConversion} created with the given
	 *         parameters.
	 */
	 ...
	 * @param locale      the {@link Locale} that determines how the date mask
	 *                    should be formatted.
	 * @param dateIfNull  default Date value to be returned when the input String is
	 *                    null. Used when {@link DateConversion#execute(String)} is
	 *                    invoked.
	 * @param dateFormats list of acceptable date patterns. The first pattern in
	 *                    this sequence will be used to convert a Date into a String
	 *                    in {@link DateConversion#revert(Date)}.
	 ...
	 * @param locale       the {@link Locale} that determines how the date mask
	 *                     should be formatted.
	 * @param dateIfNull   default Date value to be returned when the input String
	 *                     is null. Used when {@link DateConversion#execute(String)}
	 *                     is invoked.
	 * @param stringIfNull default String value to be returned when a Date input is
	 *                     null. Used when {@link DateConversion#revert(Date)} is
	 *                     invoked.
	 * @param dateFormats  list of acceptable date patterns. The first pattern in
	 *                     this sequence will be used to convert a Date into a
	 *                     String in {@link DateConversion#revert(Date)}.
	 *
	 * @return the new instance of {@link DateConversion} created with the given
	 *         parameters.
	 */
	public static DateConversion toDate(TimeZone timeZone, Locale locale, Date dateIfNull, String stringIfNull,
			String... dateFormats) {
	 ...
	 *                    should be formatted.
	 * @param dateFormats list of acceptable date patterns. The first pattern in
	 *                    this sequence will be used to convert a Calendar into a
	 *                    String in {@link CalendarConversion#revert(Calendar)}.
	 *
	 * @return the new instance of {@link CalendarConversion} created with the given
	 *         parameters.
	 */
	 ...
	 * @param locale      the {@link Locale} that determines how the date mask
	 *                    should be formatted.
	 * @param dateIfNull  default Calendar value to be returned when the input
	 *                    String is null. Used when
	 *                    {@link CalendarConversion#execute(String)} is invoked.
	 * @param dateFormats list of acceptable date patterns. The first pattern in
	 *                    this sequence will be used to convert a Calendar into a
	 *                    String in {@link CalendarConversion#revert(Calendar)}.
	 *
	 ...
	 * @param stringIfNull default String value to be returned when a Date input is
	 *                     null. Used when
	 *                     {@link CalendarConversion#revert(Calendar)} is invoked.
	 * @param dateFormats  list of acceptable date patterns. The first pattern in
	 *                     this sequence will be used to convert a Calendar into a
	 *                     String in {@link CalendarConversion#revert(Calendar)}.
	 *
	 ...
	 *         parameters.
	 */
	public static CalendarConversion toCalendar(Locale locale, Calendar dateIfNull, String stringIfNull,
			String... dateFormats) {
	 ...
	 *         parameters.
	 */
	public static CalendarConversion toCalendar(TimeZone timeZone, Locale locale, Calendar dateIfNull,
			String stringIfNull, String... dateFormats) {
	 ...
	 *
	 * @param numberFormats list of acceptable numeric patterns. The first pattern
	 *                      in this sequence will be used to convert a Number into a
	 *                      String in {@link NumericConversion#revert(Number)}.
	 *
	 * @return a new instance of {@link NumericConversion} that supports the given
	 *         number formats
	 */
	 ...
	 * Returns a new instance of {@link NumericConversion}
	 *
	 * @param numberType    type of number to be returned. The resulting instance of
	 *                      {@code Number} will be cast to the expected type.
	 * @param numberFormats list of acceptable numeric patterns. The first pattern
	 *                      in this sequence will be used to convert a Number into a
	 *                      String in {@link NumericConversion#revert(Number)}.
	 ...
	 *
	 * @param numberFormats list of acceptable numeric patterns. The first pattern
	 *                      in this sequence will be used to convert a BigDecimal
	 *                      into a String in
	 *                      {@link NumericConversion#revert(Number)}.
	 *
	 * @return a new instance of {@link FormattedBigDecimalConversion} that supports
	 *         the given number formats
	 */
	 ...
	 * Returns a new instance of {@link FormattedBigDecimalConversion}
	 *
	 * @param defaultValueForNullString default BigDecimal to be returned when the
	 *                                  input String is null. Used when
	 *                                  {@link FormattedBigDecimalConversion#execute(String)}
	 *                                  is invoked.
	 * @param numberFormats             list of acceptable numeric patterns. The
	 *                                  first pattern in this sequence will be used
	 *                                  to convert a BigDecimal into a String in
	 *                                  {@link NumericConversion#revert(Number)}.
	 *
	 * @return a new instance of {@link FormattedBigDecimalConversion} that supports
	 *         the given number formats
	 ...
	 *                                  {@link FormattedBigDecimalConversion#execute(String)}
	 *                                  is invoked.
	 * @param stringIfNull              default String value to be returned when a
	 *                                  BigDecimal input is null. Used when
	 *                                  {@code FormattedBigDecimalConversion#revert(BigDecimal)}
	 *                                  is invoked.
	 * @param numberFormats             list of acceptable numeric patterns. The
	 *                                  first pattern in this sequence will be used
	 *                                  to convert a BigDecimal into a String in
	 ...
	 *
	 * @param defaultValueForNullString  default Boolean value to be returned when
	 *                                   the input String is null. Used when
	 *                                   {@link BooleanConversion#execute(String)}
	 *                                   is invoked.
	 * @param defaultValueForNullBoolean default String value to be returned when a
	 *                                   Boolean input is null. Used when
	 *                                   {@link BooleanConversion#revert(Boolean)}
	 *                                   is invoked.
	 * @param valuesForTrue              Strings that identify the boolean value
	 *                                   <i>true</i>. The first element will be
	 *                                   returned when executing
	 *                                   {@code BooleanConversion.revert(true)}
	 * @param valuesForFalse             Strings that identify the boolean value
	 *                                   <i>false</i>. The first element will be
	 *                                   returned when executing
	 *                                   {@code BooleanConversion.revert(false)}
	 *
	 * @return a new instance of {@link BooleanConversion} with support for multiple
	 *         representations of true and false
	 */
	public static BooleanConversion toBoolean(Boolean defaultValueForNullString, String defaultValueForNullBoolean,
			String[] valuesForTrue, String[] valuesForFalse) {
		return new BooleanConversion(defaultValueForNullString, defaultValueForNullBoolean, valuesForTrue,
				valuesForFalse);
	}
	 ...
	 *                                   {@link BooleanConversion#revert(Boolean)}
	 *                                   is invoked.
	 * @param valueForTrue               String that identify the boolean value
	 *                                   <i>true</i>.
	 * @param valueForFalse              String that identify the boolean value
	 *                                   <i>false</i>.
	 *
	 * @return a new instance of {@link BooleanConversion} with support for multiple
	 *         representations of true and false
	 */
	public static BooleanConversion toBoolean(Boolean defaultValueForNullString, String defaultValueForNullBoolean,
			String valueForTrue, String valueForFalse) {
		return new BooleanConversion(defaultValueForNullString, defaultValueForNullBoolean,
				new String[] { valueForTrue }, new String[] { valueForFalse });
	}

	/**
	 * Returns a new instance of {@link BooleanConversion}
	 *
	 * @param valuesForTrue  Strings that identify the boolean value <i>true</i>.
	 *                       The first element will be returned when executing
	 *                       {@code BooleanConversion.revert(true)}
	 * @param valuesForFalse Strings that identify the boolean value <i>false</i>.
	 *                       The first element will be returned when executing
	 *                       {@code BooleanConversion.revert(false)}
	 *
	 * @return a new instance of {@link BooleanConversion} with support for multiple
	...
	/**
	 * Returns a new instance of {@link BooleanConversion} that converts the string
	 * "true" to true, and the String "false" to false.
	 *
	 * @return a new instance of {@link BooleanConversion} with support for multiple
	 *         representations of true and false
	 */
	 ...
	 * Returns a new instance of {@link CharacterConversion}
	 *
	 * @param defaultValueForNullString default Character value to be returned when
	 *                                  the input String is null. Used when
	 *                                  {@link CharacterConversion#execute(String)}
	 *                                  is invoked.
	 * @param defaultValueForNullChar   default String value to be returned when a
	 *                                  Character input is null. Used when
	 *                                  {@code CharacterConversion#revert(Character)}
	 *                                  is invoked.
	 *
	 * @return a new instance of {@link CharacterConversion}
	 */
	 ...
	 * @param <T>       the {@code enum} type
	 * @param enumType  the enumeration type to be converted from/to {@code String}
	 * @param selectors the selection elements of the enumeration to use for
	 *                  matching {@code String}s.
	 *
	 * @return new instance of {@link EnumConversion}
	 */
	 ...
	 *
	 * @param <T>               the {@code enum} type
	 * @param enumType          the enumeration type to be converted from/to
	 *                          {@code String}
	 * @param customEnumElement name of custom element of the enumeration (attribute
	 *                          or method) whose values should be used to match
	 *                          equivalent {@code String}s.
	 * @param selectors         the selection elements of the enumeration to use for
	 *                          matching {@code String}s.
	 *
	 * @return new instance of {@link EnumConversion}
	 */
	public static <T extends Enum<T>> EnumConversion<T> toEnum(Class<T> enumType, String customEnumElement,
	 ...
	 * @param enumType            the enumeration type to be converted from/to
	 *                            {@code String}
	 * @param valueIfStringIsNull the default enumeration constant to use if the
	 *                            input {@code String} is {@code null}
	 * @param valueIfEnumIsNull   the default {@code String} value to use if the
	 *                            input {@code enum} constant is {@code null}
	 * @param customEnumElement   name of custom element of the enumeration
	 *                            (attribute or method) whose values should be used
	 *                            to match equivalent {@code String}s.
	 * @param selectors           the selection elements of the enumeration to use
	 *                            for matching {@code String}s.
	 *
	 * @return new instance of {@link EnumConversion}
	 */
	public static <T extends Enum<T>> EnumConversion<T> toEnum(Class<T> enumType, T valueIfStringIsNull,
			String valueIfEnumIsNull, String customEnumElement, EnumSelector... selectors) {
	 ...
	 *
	 * @param pattern Date mask to be be used to convert a date object (i.e.
	 *                {@link Date} or {@link Calendar}) into a String.
	 *
	 * @return new instance of {@link FormattedDateConversion} configured with the
	 *         given parameters
	 */
	 ...
	 * Returns a new instance of {@link FormattedDateConversion}
	 *
	 * @param pattern             Date mask to be be used to convert a date object
	 *                            (i.e. {@link Date} or {@link Calendar}) into a
	 *                            String.
	 * @param valueIfObjectIsNull Default string value to be returned when the input
	 *                            object is null.
	 *
	 * @return new instance of {@link FormattedDateConversion} configured with the
	 *         given parameters
	 ...
	 * @param pattern Date mask to be be used to convert a date object (i.e.
	 *                {@link Date} or {@link Calendar}) into a String.
	 * @param locale  The {@link Locale} that determines how the date pattern should
	 *                be formatted.
	 *
	 * @return new instance of {@link FormattedDateConversion} configured with the
	 *         given parameters
	 ...
	 *                            (i.e. {@link Date} or {@link Calendar}) into a
	 *                            String.
	 * @param locale              The {@link Locale} that determines how the date
	...
	/**
	 * Returns a {@link ValidatedConversion} that verifies the format of a given
	 * value
	 *
	 * @param regexToMatch regular expression to match and ensure the value has a
	 *                     given format
	 *
	 ...
	 *
	 * @return new instance of {@link ValidatedConversion} configured with the given
	 *         parameters
	 */
	...
	/**
	 * Returns a new instance of {@link ValidatedConversion} to validate values of a
	 * record
	 *
	 * @param nullable    flag to indicate whether values can be null
	 * @param allowBlanks flag to indicate whether values can be blank
