...
/**
 * Converts objects of different date types ({@code java.util.Date} and
 * {@code java.util.Calendar}) to a formatted
 * date {@code String}.
 *
 * <p>
 ...
 *
 * <p>
 * The date patterns must follow the pattern rules of {@link SimpleDateFormat}
 *
...
public class FormattedDateConversion implements Conversion<Object, String> {
	...
	/**
	 *
	 * @param format              The pattern to be used to convert an input date
	 *                            into a String in
	 *                            {@link FormattedDateConversion#execute(Object)}.
	 ...
	 *                            is {@code null} . Used when
	 *                            {@link FormattedDateConversion#execute(Object)} is
	 *                            invoked with a {@code null} parameter.
	 */
	...
	public String execute(Object input) {
		...
		DataProcessingException exception = new DataProcessingException(
				"Cannot format '{value}' to a date. Not an instance of java.util.Date or java.util.Calendar");
