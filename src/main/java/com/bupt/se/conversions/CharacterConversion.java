...
public class CharacterConversion extends ObjectConversion<Character> {
	/**
	 * Creates a Conversion from String to Character with default values to return
	 ...
	 * when the input is null.
	 * 
	 * @param valueIfStringIsNull default Character value to be returned when the
	 ...
	 *                            {@code revert(Character)} is invoked.
	 */
	 ...
	 *                                  1, then an IllegalArgumentException is
	 *                                  thrown.
	 */
	@Override
