...
import com.bupt.se.annotations.EnumOptions;

/**
 * Identifies a property of an enumeration that should be used by
 * {@link EnumOptions} to identify an input value.
 * When parsing a given input, values will be compared against one of the
 * properties and if there's a match, the
 * corresponding enumeration value will be used to set the field of an annotated
 * class.
 */
