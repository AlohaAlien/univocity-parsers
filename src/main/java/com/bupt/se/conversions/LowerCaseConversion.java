 ...
 *
 * The {@link LowerCaseConversion#revert(String)} implements the same behavior
 * of {@link LowerCaseConversion#execute(String)}. Null inputs produce null
 * outputs.
 *
...
public class LowerCaseConversion implements Conversion<String, String> {
	 ...
	 * @return the lower case representation of the given input, or null if the
	 *         input is null.
	 */
	@Override
