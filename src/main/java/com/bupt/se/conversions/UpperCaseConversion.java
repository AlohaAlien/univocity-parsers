 ...
 *
 * The {@link UpperCaseConversion#revert(String)} implements the same behavior
 * of {@link UpperCaseConversion#execute(String)}. Null inputs produce null
 * outputs.
 *
...
public class UpperCaseConversion implements Conversion<String, String> {
	 ...
	 * @return the upper case representation of the given input, or null if the
	 *         input is null.
	 */
	@Override
