...
/**
 * The {@code @FixedWidth} annotation, along with the {@link Parsed} annotation,
 * allows users to configure the length,
 * alignment and padding of fields parsed/written using the
 * {@link FixedWidthParser} and {@link FixedWidthWriter}
 *
 * <p>
...
public @interface FixedWidth {
	...
	/**
	 * Configures whether to retain the padding character when parsing values for
	 * this field
	 *
