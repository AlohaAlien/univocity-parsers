...
/**
 * Performs basic validations against the String representation of the value
 * found in the annotated field.
 * A validation failure will generate a
 * {@link com.bupt.se.common.DataValidationException}.
 *
...
public @interface Validate {
	...
	/**
	 * Indicates whether this field can be blank (i.e. contain 0 or more
	 * whitespaces, where
	 ...
	 * 
	 * @return the regular expression that determines an expected format for the
	 *         given value
	 */
	 ...
	 *
	 * @return custom classes to be used to validate any value associated with this
	 *         field.
	 */
