...
/**
 * An internal registry of annotated elements and their properties that have
 * been set via a {@link com.bupt.se.annotations.Copy} annotation.
 */
public class AnnotationRegistry {
	 ...
	 * 
	 * @param annotatedElement a method or field that has an annotation whose
	 *                         properties are changed by a
	 *                         {@link com.bupt.se.annotations.Copy} annotation
	 ...
	 *                         annotation.
	 */
	static synchronized final void setValue(AnnotatedElement annotatedElement, Annotation annotation, String attribute,
			Object newValue) {
	...
	/**
	 * Returns the a value to a given annotation attribute that might have been
	 * modified by a {@link com.bupt.se.annotations.Copy} annotation
	 *
	 * @param annotatedElement a method or field that has an annotation whose
	 *                         properties might have been changed by a
	 *                         {@link com.bupt.se.annotations.Copy} annotation
	 * @param annotation       the possibly altered annotation of the given
	 *                         annotatedElement
	 * @param attribute        the attribute of the possibly altered annotation
	 * @param valueIfNull      the value to return from the unmodified annotation,
	 *                         if it has not been changed by a
	 *                         {@link com.bupt.se.annotations.Copy}
	 *
	 * @param <T>              the expected value type to be returned by this
	 *                         method.
	 *
	 * @return the value associated with the given annotation property.
	 */
	public static synchronized final <T> T getValue(AnnotatedElement annotatedElement, Annotation annotation,
			String attribute, T valueIfNull) {
	 ...
	 * @param attribute        the attribute of the possibly altered annotation
	 *
	 * @return the value associated with the given annotation property, or
	 *         {@code null} if it has not been modified by a
	 *         {@link com.bupt.se.annotations.Copy}
	 */
	static synchronized final Object getValue(AnnotatedElement annotatedElement, Annotation annotation,
			String attribute) {
		FieldAnnotations attributes = modifiedAnnotations.get(annotatedElement);
		if (attributes == null) {
			return null;
	...
	private static class AnnotationAttributes {
		...
		private void setAttribute(String attribute, Object newValue) {
			if (!attributes.containsKey(attribute)) {
				...
				if (originalClass != newClass && newClass.isArray()
						&& newClass.getComponentType() == existingValue.getClass()) {
