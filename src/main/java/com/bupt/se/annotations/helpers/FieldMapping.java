...
public class FieldMapping {
	 ...
	 * @param target      a {@link java.lang.reflect.Field} or
	 *                    {@link java.lang.reflect.Method} annotated with
	 *                    {@link Parsed}
	 * @param property    the property descriptor of this field, if any. If this
	 *                    bean does not have getters/setters, it will be accessed
	 *                    directly.
	 * @param transformer an optional {@link HeaderTransformer} to modify header
	 *                    names/positions in attributes of {@link Nested} classes.
	 * @param headers     list of headers parsed from the input or manually set with
	 *                    {@link CommonSettings#setHeaders(String...)}
	 */
	public FieldMapping(Class<?> beanClass, AnnotatedElement target, PropertyWrapper property,
	...
	private void determineFieldMapping(HeaderTransformer transformer, NormalizedString[] headers) {
		...
		if (parsed != null) { // field can be annotated with @Nested only. In this case we get the original
								// field name
	...
	/**
	 * Returns {@code true} if the field is mapped to a column index, otherwise
	 * {@code false}
	 *
	 * @return {@code true} if the field is mapped to a column index, otherwise
	 *         {@code false}
	 */
	...
	/**
	 * Returns {@code true} if the field is mapped to a column name, otherwise
	 * {@code false}
	 *
	 * @return {@code true} if the field is mapped to a column name, otherwise
	 *         {@code false}
	 */
	 ...
	 *
	 * @return the column index associated with this field, or -1 if there's no such
	 *         association.
	 */
	public int getIndex() {
		return index;
	...
	/**
	 * Defines the column index against which this field is mapped, overriding any
	 * current position derived from
	 * annotations.
	 *
	...
	/**
	 * Defines the column name against which this field is mapped, overriding any
	 * current name derived from
	 ...
	 *
	 * @return the column name associated with this field, or {@code null} if
	...
	/**
	 * Queries whether this field mapping can be applied over a given object
	 * instance.
	 *
	 * @param instance the object whose type will be verified in order to identify
	 *                 if it contains the mapped field
	 *
	 * @return {@code true} if the given instance contains the field/accessor method
	 *         and can use this field mapping to modify its internal state;
	 ...
	 *
	 * @param instance the object whose field, mapped by this field mapping, will be
	 *                 read
	 *
	...
	/**
	 * Writes a value to the field of a given object instance, whose field is
	 * accessible through this field mapping.
	 *
