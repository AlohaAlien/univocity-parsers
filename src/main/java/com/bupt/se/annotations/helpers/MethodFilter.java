...
/**
 * A filter for annotated methods. Used internally to exclude setters or getters
 * from the list of fields to be processed,
 * accordingly to the use case: when parsing into beans, only setter methods are
 * to be considered. When writing values
...
public enum MethodFilter {
	 ...
	 *
	 * @return {@code true} if the given method should be rejected, {@code false}
	 *         otherwise
	 */
	public boolean reject(Method method) {
