 ...
 * {@link HeaderTransformer} obtained from
 * {@link Nested#headerTransformer()} when nested classes are used to process
 * beans.
 *
...
public class TransformedHeader {
	...
	/**
	 * Returns the index that determines which column the current field represents,
	 * as specified by {@link Parsed#index()}
	 *
	 ...
	 *
	 * @return the field or method being manipulated by the parser/writer when
	 *         processing java beans
	 */
	...
	/**
	 * Returns {@code true} if this {@link AnnotatedElement} is a {@link Method}
	 * with parameters and can only be used
	 * for writing values into the java bean.
	 *
	 * @return a flag indicating whether this is a method that allows writing values
	 *         only.
	 */
	 ...
	 *
	 * @return a flag indicating whether this is a method that allows reading values
	 *         only.
	 */
