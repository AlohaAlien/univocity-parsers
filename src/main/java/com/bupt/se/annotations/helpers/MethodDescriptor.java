...
public final class MethodDescriptor {
	...
	/**
	 * Returns the prefix: a dot separated string denoting a path of nested object
	 * names (e.g. customer.contact).
	 *
	 ...
	 * 
	 * @return the type of parameter accepted by this method if it is a setter, or
	 *         {@code null} if a getter is being represented.
	 */
	 ...
	 * 
	 * @return the return type of this method if it is a getter, or {@code null} if
	 *         a setter is being represented.
	 */
	...
	/**
	 * Returns full path to a method, (e.g. {@code getName} or
	 * {@code person.getName}
	 * 
