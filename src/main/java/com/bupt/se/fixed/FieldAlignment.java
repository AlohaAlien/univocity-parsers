...
public enum FieldAlignment {
	...
	/**
	 * Calculates how many whites paces to introduce before a value so it is printed
	 * as specified by the alignment type.
	 * 
	 ...
	 * @return the number of whites paces to introduce in before the value to make
	 *         it align as specified.
	 */
