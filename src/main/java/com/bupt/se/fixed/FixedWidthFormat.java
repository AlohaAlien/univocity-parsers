...
/**
 * The Fixed-Width format configuration. In addition to the default
 * configuration in {@link Format}, the fixed-width format defines:
 *
 * <ul>
 * <li><b>padding <i>(defaults to ' ')</i>: </b> the character used for filling
 * unwritten spaces in a fixed-width record.
 * <p>
 * e.g. if a field has a length of 5 characters, but the value is 'ZZ', the
 * field should contain <b>[ZZ ]</b> (i.e. ZZ followed by 3 unwritten spaces).
 * <br>
 * If the padding is set to '_', then the field will be written as
 * <b>[ZZ___]</b></li>
 * </ul>
 *
...
public class FixedWidthFormat extends Format {
	...
	/**
	 * Returns the lookup wildcard character to accept any character in look-ahead
	 * or look-behind patterns defined
	 * using
	 * {@link FixedWidthParserSettings#addFormatForLookahead(String, FixedWidthFields)}
	 * or
	...
	/**
	 * Defines the lookup wildcard character to accept any character in look-ahead
	 * or look-behind patterns defined
	 * using
	 * {@link FixedWidthParserSettings#addFormatForLookahead(String, FixedWidthFields)}
	 * or
	 ...
	 * Defaults to {@code '?'}
	 *
	 * @param lookupWildcard the wildcard character to be used in lookahead/behind
	 *                       patterns.
	 */
