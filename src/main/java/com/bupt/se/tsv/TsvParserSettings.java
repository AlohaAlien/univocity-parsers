...
public class TsvParserSettings extends CommonParserSettings<TsvFormat> {
	 ...
	 * {@link TsvFormat#getEscapeChar()}
	 * and followed by a line separator character should be joined with the
	 * following line.
	 *
	 * Typical examples include inputs where lines end with sequences such as:
	 * {@code '\'+'\n'} and {@code '\'+'\r'+'\n'}.
	 *
	 * When line joining is disabled (the default), the {@link TsvParser} converts
	 * sequences containing
	 * the escape character (typically '\') followed by characters 'n' or 'r' into a
	 * '\n' or '\r' character.
	 * It will continue processing the contents found in the same line, until a new
	 * line character is found.
	 *
	 * If line joining is enabled, the {@link TsvParser} will convert sequences
	 * containing
	 * the escape character, followed by characters '\n', '\r' or '\r\n', into a
	 * '\n' or '\r' character.
	 * It will continue processing the contents found in the next line, until a new
	 * line character is found, given it is
	...
	/**
	 * Defines how the parser should handle escaped line separators. By enabling
	 * lines joining,
	 * lines ending with the escape character (defined by
	 * {@link TsvFormat#getEscapeChar()}
	 * and followed by a line separator character will be joined with the following
	 * line.
	 *
	 * Typical examples include inputs where lines end with sequences such as:
	 * {@code '\'+'\n'} and {@code '\'+'\r'+'\n'}.
