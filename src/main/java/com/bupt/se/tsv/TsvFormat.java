...
/**
 * The TSV format configuration, for tab-separated inputs. It offers the options
 * in the default configuration in {@link Format}, as well as
...
public class TsvFormat extends Format {
	 ...
	 * the character before the defined
	 * {@link #getEscapeChar()}. For example, if {@link #getEscapeChar()} == '\\'
	 * and {@link #getEscapedTabChar() == 'X'},
	 * the sequence {@code '\X'} will identify a tab.
	 *
	 * Defaults to {@code 't'}.
	 *
	 * @return the character following the {@link #getEscapeChar()} that represents
	 *         an escaped tab.
	 */
	 ...
	 * Defaults to {@code 't'}.
	 *
	 * @param escapedTabChar the character following the {@link #getEscapeChar()}
	...
	/**
	 * Identifies whether or not a given character is used for escaping special
	 * characters in TSV (\t, \n, \r and \).
	 * 
