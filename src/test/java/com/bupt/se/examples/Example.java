...
public abstract class Example extends OutputTester {
	...
	/**
	 * Modifies the values of an array of Strings to make line separator characters
	 * `visible` by replacing
	 * them with their character escapes
	 *
	 * @param input the input array whose values will have line separators replaced
	 *              by escape sequences.
	 *
	...
	/**
	 * Prints and validates rows in a map consisting of entity names and their
	 * respective rows.
	 *
